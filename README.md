...
*   [dotnet/modernize-dotnet](https://github.com/dotnet/modernize-dotnet) - A tool to assist developers in upgrading .NET Framework applications to .NET 6 and beyond
